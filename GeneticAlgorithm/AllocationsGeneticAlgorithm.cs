...
public class AllocationsGeneticAlgorithm 
{
    ...
    public AllocationsGeneticAlgorithm(int populationSize, double mutationChance, int immigrantCount, int generationCount, FitnessSectorCalculations fitnessSector)
    {
