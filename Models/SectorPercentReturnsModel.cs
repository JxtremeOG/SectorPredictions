public class SectorPercentReturnsModel {
    ...
    public SectorPercentReturnsModel(double day30Percent, double day90Percent, double day365Percent, double day1095Percent) {
